"""
Django settings for tool_shanty_39026 project.
...
ROOT_URLCONF = 'tool_shanty_39026.urls'
...
WSGI_APPLICATION = 'tool_shanty_39026.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tool_shanty_39026 API",
    "DESCRIPTION": "API documentation for tool_shanty_39026 App",
    "VERSION": "v1",
}
